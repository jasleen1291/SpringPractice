...
public class RedBlackTreeTest {
	 ...
	 @Test
	    public void test1() {
	       ...
	       tree.delete(rbNode18);
	     /*  RBNode node93=new RBNode(tree, 93);
	       tree.insert( node93);
	       System.out.println(node93.getColor());
	       System.out.println(node93.sibling());
	       System.out.println(node93.sibling().getColor());
	       tree.insert(new RBNode(tree, 94) );
	       */
